...
export default function SimpleContainer() {
  ...
  return (
    <div
      style={{
        backgroundImage:
          "url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAQQAAACUCAMAAABCx6fPAAAAA1BMVEWt2eZvScryAAAAPElEQVR4nO3BAQ0AAADCoPdPbQ43oAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAB4NZbkAAH2/RHoAAAAAElFTkSuQmCC)",
            ...
            >
              ...
              >
                ...
                <Link
                  ...
                  to="/login"
                >
                  You already have an account? in LMS
                </Link>
              </Box>
            </div>
          </form>
